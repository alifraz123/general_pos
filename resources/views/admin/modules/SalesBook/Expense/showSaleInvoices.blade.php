                ...
                <td>
                  <a style="color: white;width:100%;position:absolute">
                    ...
                    <div style="cursor:pointer;position: relative;top:0px;left:0px;display:none;z-index:1000;padding:10px;background-color:white;color:black" class="showHideDiv{{$saleInvoice->Invoice}}">
                      <p onclick="editFunction('edit_expensebookInvoice/{{$saleInvoice->Invoice}}','showHideDiv{{$saleInvoice->Invoice}}')" >
                      Edit
                      </p>
  
                      <p class="dropdown-item " onclick="confirmToDelete('delete_dispatch_expensebook?startDate={{$saleInvoice->Date}}&endDate={{$saleInvoice->Date}}&Invoice={{$saleInvoice->Invoice}}')">
                        Delete
                      </p>
